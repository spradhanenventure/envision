...
namespace ENVision
{
    [Activity(Label = "Edit Stock")]
    public class EditSingleStockActivity : Activity
    {
        private int id;
        private String name;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            tv_label.Text = "Enter stock of " + name + ":";
            ...
            b_save.Click += delegate
            {
                ...
                p.ProductStock = int.Parse((et_value.Text.Equals("")) ? "0" : et_value.Text);
                connection.Update(p);
