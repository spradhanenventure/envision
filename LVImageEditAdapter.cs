...
namespace ENVision
{
    [Activity(Label = "LVImageEditAdapter")]
    class LVImageEditAdapter : BaseAdapter
    {
        ...
        public LVImageEditAdapter(Activity activity, List<DataTwoItems> itemList)
        {
            _activity = activity;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                ...
                convertView = _activity.LayoutInflater.Inflate(Resource.Layout.LVImageEditLayout, parent, false);
                holder.imageView = convertView.FindViewById<ImageView>(Resource.Id.et1);
            ...
            var view = convertView ?? _activity.LayoutInflater.Inflate(Resource.Layout.LVImageEditLayout, parent, false);
            ...
            Bitmap bmImg = BitmapFactory.DecodeFile(item.item1);
